                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('application.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="sectors" name="sectors[]" multiple size="15">
                        ...
                        <div class="block mt-4">
                            <label for="agreement" class="inline-flex items-center">
                                <input id="agreement" name="agreement" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
